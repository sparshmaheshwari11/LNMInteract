...
// This seems to be a middleware function that wraps asynchronous route 
// handlers and handles errors within those handlers, allowing for cleaner error handling code
...
// This is a route handler function that provides access to private data for authenticated users.
...
const forgotpassword  = asyncErrorWrapper( async (req,res,next) => {
    ...
    const emailTemplate = `<h3 style="color : red "> Reset Your Password </h3>
